...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
       ...
       // WLClient.getInstance().pinTrustedCertificatePublicKey("schalcom.pem");
        WLClient.getInstance().pinTrustedCertificatePublicKey("demopersistent.der");
       ...
       // WLClient.getInstance().pinTrustedCertificatePublicKey("github.ibm.der");
            ...
            public void onClick(View v) {
                ...
                try {
                   adapterPath = new URI("/adapters/ResourceAdapter/balance");
                    //adapterPath = new URI("https://www.w3school.com/");

                } catch (URISyntaxException e) {
                    e.printStackTrace();
                }
                WLResourceRequest request = new WLResourceRequest(adapterPath, WLResourceRequest.GET,"accessRestricted");
