...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button jsonButton = (Button) findViewById(R.id.jsonstore);
        Button liveupdate = findViewById(R.id.liveupdate);
        liveupdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginActivity.this,LiveUpdate.class);
...
//                webView.loadUrl("https://mmpstore.metlife.co.kr");
            }
        });
