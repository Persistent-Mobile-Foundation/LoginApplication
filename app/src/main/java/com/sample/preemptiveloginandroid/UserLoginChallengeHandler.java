...
//        Intent intent = new Intent(Intent.ACTION_VIEW).setData(Uri.parse("https://mfp.demopersistent.com/mfpconsole/login.html#/mfp/registerApp"));
...
//
    ...
    public void handleChallenge(JSONObject jsonObject) {
        ...
        isChallenged = true;
      //  WLClient.getInstance().setServerUrl();
        try {
