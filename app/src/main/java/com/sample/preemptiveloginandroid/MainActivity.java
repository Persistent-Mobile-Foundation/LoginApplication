...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        removeCollectionButton.setOnClickListener(new View.OnClickListener() {
        ...
        findByAgeButton.setOnClickListener(new View.OnClickListener() {
        ...
        replaceByIdButton.setOnClickListener(new View.OnClickListener() {
        ...
        removeByIdButton.setOnClickListener(new View.OnClickListener() {
        ...
        loadDataFromAdapterButton.setOnClickListener(new View.OnClickListener() {
        ...
        getDirtyDocumentsButton.setOnClickListener(new View.OnClickListener() {
        ...
        pushChangesToAdapterButton.setOnClickListener(new View.OnClickListener() {
        ...
        countAllButton.setOnClickListener(new View.OnClickListener() {
        ...
        countByNameButton.setOnClickListener(new View.OnClickListener() {
        ...
        getFileInfoButton.setOnClickListener(new View.OnClickListener() {
